    ...
    methods: {
      ...
      aboutPage() {
        ...
        this.$swal({
          ...
          <br>浙江工商大学 计算机与信息工程学院 孔启超 杨镐<br>
          <hr>
          <i>The Challenge:</i>
      ...
      aboutPage2() {
        ...
        this.$swal({
          ...
          focusConfirm: false,
          // backdrop: 'rgba(206, 225, 255, 0.45)',
          html: `Audio Explorer 是一款数据可视化工具，来帮助研究人员分析特定位置的录音
           并可以随着时间的推移并验证其真实性。
          <br>
          原题地址
          <a href="http://www.vacommunity.org/VAST+Challenge+2018+MC1" target="_blank">2018 VAST Challenge. </a>
          ...
          `,
          confirmButtonText: 'First-time user?',
          footer: `<p>二次开发 浙江工商大学 计算机与信息工程学院 孔启超 杨镐
          <a href="https://github.com/chadstolper/vast-challenge-2018-mc1" target="_blank">
          <br>
          <img width="16" src="/data/icons/GitHub-Mark-32px.png" alt="">访问GitHub</a>
          </br>
          特别感谢 Dr. Stolper 和
          <a href="https://www.southwestern.edu/scope/" target="_blank"> SCOPE program </a>西南大学</p>`,
        })
        .then((result) => {
          if (result.value) {
            this.$swal.mixin({
